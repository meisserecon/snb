...
public class BitcoinPrice extends TimeSeries {
	...
	public BitcoinPrice(String dataFolder, DollarExchangeRate usd) throws FileNotFoundException, IOException {
		super("Bitcoin");
		// https://www.cryptodatadownload.com/cdd/Bitstamp_BTCUSD_d.csv
		List<String> lines = Files.readAllLines(FileSystems.getDefault().getPath(dataFolder, "Bitstamp_BTCUSD_d.csv"));
